...
def config():
    ...
    # for dataset
    parser.add_argument('--datapath', default='/root/yujevolume/dataset', type=str, metavar='PATH',
    ...
    parser.add_argument('--lr', '--learning-rate', default=0.1, type=float,
                        ...
                        dest='lr')
    parser.add_argument('--acceleration', default=0, type=int,
                        metavar='accel', help='acceleration learning rate (default: 0)',
                        dest='accel')
    ...
    parser.add_argument('--prune-rate', dest='prune_rate', default=0.5, type=float,
                         help='pruning rate') 
    parser.add_argument('--prune-imp', dest='prune_imp', default='conv', type=str,
                         help='Importance Method : group_(optional) + conv, bn, coba')
    parser.add_argument('--prune-imptype', dest='prune_imptype', default='L1', type=str,
                         help='Importance Type : L1, L2, grad, syn')
    parser.add_argument('--shrink', action='store_true', help='use shrinked model')

    # yuje
    parser.add_argument('--test_name',default='None',type=str)
    parser.add_argument('--bias_importance',default=1,type=float)
    parser.add_argument('--imp_type',default=0,type=int)
    parser.add_argument('--imp_type_describe',default='None',type=str)
