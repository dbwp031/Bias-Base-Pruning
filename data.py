...
def cifar100_loader(batch_size, num_workers, datapath, cuda):
    ...
    trainset = CIFAR100(
        root=datapath, train=True, download=False,
        transform=transform_train)
    valset = CIFAR100(
        root=datapath, train=False, download=False,
        transform=transform_val)
...
def DataLoader(batch_size, image_size, num_workers, dataset='things', datapath='/dataset/things_v1', cuda=True):
