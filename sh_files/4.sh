...
python3 /home/dircon/yuje/CoBaL_code/main.py cifar10 -a resnet --layers 110 -C -g 0 --save DPFWBNR2layerimp105corr1e5 --run-type train \
...
--bias_importance 1 --imp_type 16 -g 3
